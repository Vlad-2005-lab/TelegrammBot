...
class Boss(SqlAlchemyBase, UserMixin):
    ...
    name_of_compamy = sqlalchemy.Column(sqlalchemy.String, nullable=True, default="нет")
    name_of_vacansy = sqlalchemy.Column(sqlalchemy.String, nullable=True, default="нет")
